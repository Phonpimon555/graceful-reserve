        ...
        <div className="grid md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <a 
              href="https://line.me/R/ti/p/@745cqaji" 
              className="inline-flex items-center gap-2 rounded-full glass-dark px-4 py-2 text-sm hover:bg-gold hover:text-primary transition-colors border-white/10">
